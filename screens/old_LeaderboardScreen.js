...
import { StyleSheet, View, TextInput, ScrollView, FlatList, TouchableOpacity,TouchableWithoutFeedback } from 'react-native';
import {
    Container,
    Content,
    Form,
                        ...
                        <View style={styles.form}>
                            <Form>
                                <Item>
                                    ...
                                    <TouchableWithoutFeedback onPress={() => fetchPlayers(this.state.inputName)}>
